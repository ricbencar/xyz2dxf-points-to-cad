...
$$
h = \text{Grid Spacing} = 20,
\qquad
\text{Max TPS Points} = 0.
$$
...
$$
\text{PDMODE} = \text{user-specified integer}.
$$
...
\left[
\begin{array}{cc}
\mathbf{K} + \lambda \mathbf{I} & \mathbf{P} \\
\mathbf{P}^{\mathsf T} & \mathbf{0}
\end{array}
\right]
\left[
\begin{array}{c}
...
C_{\mathrm{raw}}
\cdot
\frac{1}{1 + \dfrac{r_{\mathrm{loc}}}{s_{\mathrm{obs}}}}
\right),
$$
